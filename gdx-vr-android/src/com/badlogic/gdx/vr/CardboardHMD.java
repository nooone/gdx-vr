...
public class CardboardHMD implements HeadMountedDisplay {
	...
	private DisplayMetaInformation displayMetaInformation;

	private DisplayOpticsInformation displayOpticsInformation;

	public CardboardHMD(CardboardDeviceParams cardboardDeviceParams) {
		this.cardboardDeviceParams = cardboardDeviceParams;
		this.displayMetaInformation = new CardboardDisplayMetaInformation(cardboardDeviceParams);
	}
